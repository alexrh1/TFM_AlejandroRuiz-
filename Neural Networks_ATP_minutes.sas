...
vardep=minutes,porcen=0.80,semilla=471145,ocultos=18,algo=BPROP MOM=0.5 LEARN=0.1,acti=SOF);
...
/*tercer intento de red neuronal*/
...
conti= min_rank_points IMP_REP_min_rank LOG_IMP_REP_min_rank IMP_REP_min_age aleat,
categor=tourney_level best_of round G_tourney_name,
ngrupos=4,sinicio=12345,sfinal=12375,nodos=15,early=15,algo=LEVMAR, acti=SOF);
data final9;set final;modelo=9;

%cruzadaneural(archivo=atp,vardepen=minutes,
conti= min_rank_points IMP_REP_min_rank LOG_IMP_REP_min_rank IMP_REP_min_age aleat,
categor=tourney_level best_of round G_tourney_name,
ngrupos=4,sinicio=12345,sfinal=12375,nodos=18,early=,algo=LEVMAR, acti=SOF);
data final10;set final;modelo=10;

proc printto ;run;

data union;set final1 final5 final6 final7 /*final8*/ final9 /*final10*/ ;
proc boxplot data=union;plot media*modelo;run;
